...
![alt text](https://github.com/donnapersonal/solve_leetcode/blob/main/solutions/images/example67.png)
...
class Solution {
    ...
    void traverse(TreeNode root1, TreeNode root2) {
        ...
        // 若 root1 没有子树而 root2 有，就把 root2 的子树接到 root1 上
        // 注意接完后把 root2 的子树置为 null，免得错误计算节点累加值
