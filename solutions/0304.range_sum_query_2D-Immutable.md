...
![1](https://github.com/donnapersonal/solve_leetcode/blob/0e3a3a32d5b95d6629383bb84a066ca0221e9163/solutions/images/example23.png)
...
![alt text](https://github.com/donnapersonal/solve_leetcode/blob/b8ef67e2ac35d674238556389f499aee0ac71377/solutions/images/sum_query1.png)
...
class NumMatrix {
    ...
    public NumMatrix(int[][] matrix) {
        ...
        for(int i = 1; i <= m; i++) {
            for(int j = 1; j <= n; j++) {
                // 为了方便计算，preSum 数组的大小比原始矩阵大一行和一列，目的是为了简化边界情况的计算
                // 计算每个矩阵 [0, 0, i, j] 的元素和
